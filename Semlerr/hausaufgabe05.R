# Hausaufgabe 05
# Romy Semlerr <Semlerr@students.uni-marburg.de>
# 2014-05-04
...
# Verwischt doch eigentlich die Ergebnisse. Männer sind ja auch Studenten.
...
# Studiengänge mit großer Verteilungsspannweite  (klinische und other) haben einen vergleichsweise niedrigeren Mittelwert, als andere.
...
# Speech Science hat am meisten Faruen, die mittelgroß sind. Klinische Linguistik hat nicht sehr viele mittelgroße, dafür mehr maximal bzw minimalgroße Frauen.
